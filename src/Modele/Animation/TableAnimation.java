...
public class TableAnimation {
	...
	private static Map<ChoixAnimation, Animation> tableAnimations = new HashMap<ChoixAnimation, Animation>();

	public static Animation getPersonnageMarcheDroite() {
	...
	public static Animation getPersonnageMarcheGauche() {
	...
	public static Animation getPersonnageMarcheHaut() {
	...
	public static Animation getPersonnageMarcheBas() {
	...
	public static Animation getPersonnageDeboutDroite() {
		if (tableAnimations.get(ChoixAnimation.Personnage_Marche_Droite) == null) {
			Sprite spritePersonnage = new Sprite("rockford");
	...
	public static Animation getPersonnageDeboutGauche() {
	...
	public static Animation getPersonnageDeboutHaut() {
	...
	public static Animation getPersonnageDeboutBas() {
	...
	public static Animation getPersonnageIdle() {
	...
	public static Animation getPersonnageMort() {
